...
public:
    double findMedianSortedArrays(vector<int>& nums1, vector<int>& nums2) {
        ...
        while (1) {
            ...
            if (nums1_length == 0) {  // nums1 has 0
            ...
            } else if (nums1_length == 1 && nums2_length == 1) {  // nums1, nums2 both have 1
            ...
            } else if (nums1_length == 2 && nums2_length == 2) {  // nums1, nums2 both have 2
                return double(max(nums1[nums1_left], nums2[nums2_left]) +
                              min(nums1[nums1_right - 1], nums2[nums2_right - 1])) /
                       2;                    // It's magic......
                ...
                if (nums2_length % 2 == 1) {
                    ...
                    return double(n1 + n2 + n3 + n4 - max(max(n1, n2), max(n3, n4)) - min(min(n1, n2), min(n3, n4))) /
                           2;
                }
                ...
                int nums2MedianOffset = (nums2_length - 1) / 2;
                double nums1Median =
                    double(nums1[nums1_left + nums1MedianOffset] + nums1[nums1_right - nums1MedianOffset - 1]) / 2;
                double nums2Median =
                    double(nums2[nums2_left + nums2MedianOffset] + nums2[nums2_right - nums2MedianOffset - 1]) / 2;
